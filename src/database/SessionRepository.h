...
public:
    ...
    void setTsslBackupWebDavPath(const QString& path);
    QString tsslBackupS3Endpoint() const;
    void setTsslBackupS3Endpoint(const QString& endpoint);
    QString tsslBackupS3Bucket() const;
    void setTsslBackupS3Bucket(const QString& bucket);
    QString tsslBackupS3Region() const;
    void setTsslBackupS3Region(const QString& region);
    QString tsslBackupS3Prefix() const;
    void setTsslBackupS3Prefix(const QString& prefix);
